...
if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("MARKxHUB | Blox Fruit",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    spawn(function()
        ...
        Main:AddSeperator("Candy")
            ...
            Main:AddToggle("Auto Farm Candy",_G.AutoFarmCandy,function(value)
    ...
    Main:AddToggle("Auto By ExpX2 [50 Candy]",_G.Auto_Ex2,function(value)
        _G.Auto_Ex2 = value
    end)
    ...
    DevilFruit:AddToggle("Grab Fruit",_G.BringFruit,function(value)
        ...
        DevilFruit:AddToggle("Bring All Fruit",_G.BringFruitBF,function(value)
