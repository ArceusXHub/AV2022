if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
    ...
    --------------------------------------------------------------------
    local RenUi = library:AddWindow("AESX Hub | Blox Fruit",Enum.KeyCode.RightControl)
    --------------------------------------------------------------------
    ...
    Main:AddToggle("Bring Mob V.2",function(value)
    _G.BringMob = value
            ...
            for n,y in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if x.Name == Ms then
                    if y.Name == Ms then
                        ...
                        y.HumanoidRootPart.Size = Vector3.new(80,80,80)
                        x.HumanoidRootPart.Size = Vector3.new(80,80,80)
...
elseif game.PlaceId == 4520749081 or game.PlaceId == 6381829480 or game.PlaceId == 5931540094 or game.PlaceId == 5931540094 then
    ...
    --
    local RenUi = library:AddWindow("AESX Hub | KL",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
...
elseif game.PlaceId == 6329844902 then
    ...
    --
    local RenUi = library:AddWindow("AESX Hub | LP",Enum.KeyCode.RightControl)
    --
    local Main = RenUi:AddTab("Auto Farm","6026568198")
    local Stats = RenUi:AddTab("Stats","7040410130")
    local Combat = RenUi:AddTab("Combat","7251993295")
